...
// export const handleAsyncActionsById = (type: typeof GET_POST, key: 'post', keepData: boolean): (state: PostsStateType, action: any) => PostsStateType => {
//   const [SUCCESS, ERROR] = [`${type}_SUCCESS`, `${type}_ERROR`]
...
//   initial: (): StateObjectType<PostDataType[], unknown> => ({
//     isLoading: false,
//     data: null,
//     error: null,
//   }),
//   loading: (data: PostDataType | unknown | PostDataType[] | null = null): StateObjectType<PostDataType | unknown, unknown> => ({
//     isLoading: true,
//     data,
//     error: null,
//   }),
//   success: (data: PostDataType | PostDataType[]): StateObjectType<PostDataType | PostDataType[], unknown> => ({
//     isLoading: false,
//     data,
//     error: null,
//   }),
//   error: (error: unknown): StateObjectType<PostDataType[], unknown> => ({
//     isLoading: false,
//     data: null,
//     error,
//   }),

...
export type StateObjectType<U> = {
  isLoading: boolean
  data: postsAPI.PostDataType[] | postsAPI.PostDataType | null
  error: U | null
}

export type PostsStateType = {
  posts: StateObjectType<unknown>
  post: {
    [id: string]: StateObjectType<unknown>
  }
}
...
export default function posts(
  state: PostsStateType = inintialState,
  action: PostsActionType<unknown>
): PostsStateType {
  switch (action.type) {
    case GET_POSTS:
